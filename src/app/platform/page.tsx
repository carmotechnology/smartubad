...
import { OwnerInviteForm } from "@/components/platform/owner-invite-form";
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  ...
                  <OwnerInviteForm
                    ...
                    label={t.platform.inviteOwner}
                    emailLabel={t.platform.ownerEmail}
                    helpText={t.platform.ownerEmailHelp}
                  />
                </CardContent>
              </Card>
            </li>
